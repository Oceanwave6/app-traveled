...
describe('=== Authentication ===', () => {
  ...
  it.only('should display the login page', () => {
    cy.get(':nth-child(1) > .MuiInput-root-6 > .MuiInput-input-14').as('emailInput')
    cy.get(':nth-child(2) > .MuiInput-root-6 > .MuiInput-input-14').as('passwordInput')
    cy.get('.MuiButtonBase-root-34').as('loginButton')
